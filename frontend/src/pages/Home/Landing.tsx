    ...
    <div className='px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
      <div className='max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12'>
        ...
        <p className='text-base text-gray-700 md:text-lg'>
          Like to try out new foods? Have a recipe that you would like to share
          to the world? Great! Start your journey here ...
        </p>
      </div>
      <div className='grid gap-8 row-gap-10 lg:grid-cols-2'>
        <div className='max-w-md sm:mx-auto sm:text-center'>
          ...
          <h6 className='mb-3 text-xl font-bold leading-5'>Create a recipe</h6>
          <p className='mb-3 text-sm text-gray-900'>
            Mix together 1 large smile, 2 cups of sweetness and positivity , A
            good sense of humour, 1 cup of self esteem AND a heart full of love
        ...
        <div className='max-w-md sm:mx-auto sm:text-center'>
          ...
          <p className='mb-3 text-sm text-gray-900'>
            ...
            has a history. It has a story. It has relationships. Discover now!
          </p>
        </div>
        <div className='max-w-md sm:mx-auto sm:text-center'>
          <div className='flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-teal-50 sm:mx-auto sm:w-24 sm:h-24'>
